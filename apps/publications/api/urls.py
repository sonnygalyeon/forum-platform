...
urlpatterns = [
    ...
    path(
        ...
        "<uuid:publication_id>/"
        "revisions/",
        PublicationRevisionListView.as_view(),
        name="publication-revisions",
    ),

    path(
        "publications/"
        "<uuid:publication_id>/"
        "revisions/<int:revision_number>/",
        PublicationRevisionDetailView.as_view(),
        name="publication-revision-detail",
    ),
]