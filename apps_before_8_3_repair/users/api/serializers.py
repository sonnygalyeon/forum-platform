...
class UserPublicSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["id", "nickname", "first_name", "last_name", "country", "nationality", "bio", "date_joined"]

class UserMeSerializer(serializers.ModelSerializer):
    id = serializers.UUIDField(source="public_id", read_only=True)
    class Meta:
        model = User
        fields = ["id", "nickname", "email", "first_name", "last_name", "country", "nationality", "interface_language", "bio", "is_active", "is_staff", "is_superuser", "date_joined"]
        read_only_fields = ["id", "nickname", "email", "is_active", "is_staff", "is_superuser", "date_joined"]
...
class RegisterSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        candidate = User(nickname=attrs["nickname"], email=attrs["email"], first_name=attrs["first_name"], last_name=attrs["last_name"])
