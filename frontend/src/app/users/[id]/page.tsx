...
import { BellOff, ShieldBan, UserMinus, UserPlus } from "lucide-react";
...
export default function PublicProfilePage(){
  const {id}=useParams<{id:string}>(); const {user:me}=useAuth(); const qc=useQueryClient(); const [tab,setTab]=useState<"publications"|"answers">("publications");
