...
export type MessengerAppearance = {
  chat_theme: "iris" | "ocean" | "violet" | "amber" | "rose" | "mono";
  wallpaper: "iris-grid" | "midnight" | "aurora" | "paper" | "graphite" | "none" | "custom";
  wallpaper_asset: MediaAsset | null;
  wallpaper_dim: number;
  wallpaper_blur: boolean;
  message_scale: "small" | "normal" | "large";
};
